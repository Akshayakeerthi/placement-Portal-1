...
export default {
  ...
  template: `
    <div class="glass-card p-3 p-md-4">
      ...
      <div class="card shadow-sm mb-3" v-if="activeTab==='students'">
      ...
      <div class="card shadow-sm mb-3" v-if="activeTab==='companies'">
      ...
      <div class="card shadow-sm" v-if="activeTab==='drives'">
      ...
      <div class="card mt-3 shadow-sm" v-if="activeTab==='drives' && selectedDrive">
